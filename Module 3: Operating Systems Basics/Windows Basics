...
** Completed lab using the Windows Server 2019 operating system to read files, install programs, and run security scans on your new workstation.

Conclusion - explored the fundamentals of the Windows operating system.
